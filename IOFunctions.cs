class IOFunctions
{
    public static void Write(List<string> Tokens, int i, List<string> ConvertedTokens, List<string> IntsDeclared, List<string> StringsDeclared, List<string> FloatsDeclared)
    {
